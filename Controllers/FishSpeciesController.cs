...
namespace FishBuddy.Controllers
{
    public class FishSpeciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FishName,Location,ExperienceLevel,MaxLength,MaxWeight,BestSeason")] FishSpecies fishSpecies)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FishName,Location,ExperienceLevel,MaxLength,MaxWeight,BestSeason")] FishSpecies fishSpecies)
        {
